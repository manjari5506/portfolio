    ...
    <Card className="quote-card-view">
      <Card.Body>
        <blockquote className="blockquote mb-0">
          ...
          Hello! My name is Manjari Raikwar. I am a Full-stack Web developer and a Computer Science graduate. I like many different directions related to the development of digital products.
            <br/>
            <br/>
